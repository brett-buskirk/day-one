...
(through v1.6.0)**. This file is the per-sprint build log — how to run it and what was
...
- **Content breadth (ongoing):** a transportation/housing pass added three events
  ...
  **Tasha** (a reunifying parent with a custody arc) — bringing the roster to **nine**.
  The corpus has since grown to **56 events** across all tracks, and the character-select
